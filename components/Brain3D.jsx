...
export default function Brain3D() {
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      planeX.add(params.planeX, 'constant').min(-1)      .max(1)
  ...
  return () => {
    // Cleanup Three.js resources here (if necessary)
  };
}, []); // Empty dependency array to run the effect only once

return <div className="max-w-screen-md mx-auto" ref={containerRef} />;
}
